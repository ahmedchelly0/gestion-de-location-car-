<html>
  ...
  <head>
    <title> customer Signup | Jalandhar Car Rental </title>
  </head>
  <?php session_start(); ?>
...
if (!empty($_FILES["uploadedimage"]["name"])) {
    ...
    if(move_uploaded_file($temp_name, $target_path)) {
      ...
      //  $query0 = "UPDATE cars SET car_img = '$target_path' WHERE ";
        ...
        /*$v= new voiture();
        $success= $v -> insert( $car_name,$car_nameplate,$target_path,$ac_price,$non_ac_price,$ac_price_per_day,$non_ac_price_per_day ,$car_availability);
        echo'+++++++++++';
        print_r($success);*/
    } 
